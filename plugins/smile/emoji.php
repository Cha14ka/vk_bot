<?php
$plug_cmds = array('эмоджи', 'emoji');
$plug_smalldescription = 'Перевести фразу в язык эмоджи';
$plug_mainfunc = function ($kb_msg){
	...
	$url = 'https://translate.yandex.net/api/v1/tr.json/translate?id=b5c0902b.5a638058.9df0e44c-0-0&srv=tr-text&lang=ru-emj&reason=auto&text='.$answer;
